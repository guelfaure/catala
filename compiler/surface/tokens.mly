...
%token BEGIN_DIRECTIVE END_DIRECTIVE LAW_INCLUDE MODULE_DEF MODULE_USE MODULE_ALIAS EXTERNAL
%token<int> AT_PAGE
...
%token COMBINE MAP_EACH MAXIMUM MINIMUM IS OR_IF_LIST_EMPTY BUT_REPLACE
